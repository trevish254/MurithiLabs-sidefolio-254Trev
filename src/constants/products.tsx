...
export const products = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p>Premium Mockup design for presenting web applications in a realistic context.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>Minimalist A4 Book stack presentation focusing on clean typography and layout.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>Experimental font design showcasing the intersection of type and 3D product surfaces.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>Modern mobile application interface design optimized for OLED displays and ergonomics.</p>
      </div>
    ),
  },
];
