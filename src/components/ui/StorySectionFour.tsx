      ...
      <section className="parallax__header">
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            ...
            <img src="/Branding-mid mountain.webp" loading="eager" data-parallax-layer="3" alt="" className="parallax__layer-img" style={{ zIndex: 2, height: '150%', width: '100%', objectFit: 'cover', top: '2%', left: 0, transform: 'scale(1.25)' }} />
            
            <img src="/Branding.webp" loading="eager" data-parallax-layer="4" alt="" className="parallax__layer-img" style={{ zIndex: 3, height: '65%', width: 'auto', objectFit: 'contain', bottom: '0', top: 'auto', left: '50%', transform: 'translateX(-50%)' }} />
          </div>
