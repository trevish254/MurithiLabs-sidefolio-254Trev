      ...
      <section className="parallax__header">
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            ...
            <img src="/web development mid mountain.webp" loading="eager" data-parallax-layer="3" alt="" className="parallax__layer-img" style={{ zIndex: 2, top: '8%' }} />
            
            <img src="/web development.webp" loading="eager" data-parallax-layer="4" alt="" className="parallax__layer-img" style={{ zIndex: 3, height: '80%', width: 'auto', objectFit: 'contain', bottom: '0', top: 'auto', left: '50%', transform: 'translateX(-50%)' }} />
          </div>
